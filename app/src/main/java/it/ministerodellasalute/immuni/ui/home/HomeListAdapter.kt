...
class HomeListAdapter(
    ...
    inner class InformationCountriesOfInterestVH(v: View) : RecyclerView.ViewHolder(v)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val (layout, cardType) = when (viewType) {
            ...
            4 -> Pair(R.layout.home_countries_of_interest, InformationCountriesOfInterestVH::class)
