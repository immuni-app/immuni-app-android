val testSurveyJson = """
{
  ...
  "questions": [
    ...
    },
    {
      ...
      "only_when": {
        "type": "states_contain",
        "states": ["is_waiting_for_test_response"]
      },
      "state_updater": [
        {
    ...
    },
    {
      "only_when": {
        "type": "states_contain",
        "states": ["survey_completed_at_least_once"]
      },
      "widget": { "type": "radio", "answers": ["Si", "No", "Non so"] },
      "jump": [
        {
  ...
  "triage": {
    ...
    "logic": [
      {
        "profile_id": "positivo",
        "condition": { "type": "states_contain", "states": ["is_positive"] }
      },
      {
        "profile_id": "sintomi_gravi",
        "condition": { "type": "states_contain", "states": ["has_high_fever"] }
      },
      {
      ...
      { "profile_id": "sano_no_contatto", "condition": { "type": "true" } }
    ]
  }
}
""".trimIndent()
