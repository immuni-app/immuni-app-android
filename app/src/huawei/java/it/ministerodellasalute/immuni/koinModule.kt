...
val appModule = module {
    ...
    single {
        ExposureNotificationManager(androidContext(), get(), if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            PendingIntent.getForegroundService(
                androidContext(),
                0,
                Intent(androidContext(), BackgroundContactShieldIntentService::class.java),
