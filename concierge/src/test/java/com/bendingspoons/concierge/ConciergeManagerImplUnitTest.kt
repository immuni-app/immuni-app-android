...
class ConciergeManagerImplUnitTest {
    ...
    val appCustomIdProvider: ConciergeCustomIdProvider = object : ConciergeCustomIdProvider {
    ...
    fun `test custom ids cannot contain internal ids`() {
        ...
        customIds = setOf(Concierge.Id.Internal(Concierge.InternalId.BACKUP_PERSISTENT_ID,"value", Concierge.CreationType.justGenerated))
