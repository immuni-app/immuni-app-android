...
class ConciergeInstrumentedTest {
    ...
    val appCustomIdProvider = object : ConciergeCustomIdProvider {
    ...
    fun testIdSerializationSavingAndRestore() {
        ...
        val saved = Concierge.Id.Internal(Concierge.InternalId.BACKUP_PERSISTENT_ID, "123456", Concierge.CreationType.justGenerated)
        storage.save(saved)
    ...
    fun testLoadedIdHasReadFromFileCreationType() {
        ...
        // add id in storage
        storage.apply {
            val id = Concierge.Id.Internal(Concierge.InternalId.BACKUP_PERSISTENT_ID,
